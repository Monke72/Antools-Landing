import figma from "../images/grommet-icons_figma.svg";
import Button from "./Button";
function Tools({ img, name, payment, text }) {
  return (
    <div className="tools_con">
      <div className="top__info">
        <img className="top__info-img" src={figma} alt="" />
        <div className="top__info-head">
          <p className="top__info-head__name">FIGMA</p>
          <span className="top__info-head__payment">Free</span>
        </div>
      </div>
      <div className="tools__text">
        <p className="tools__text-info">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
      </div>
      <div className="tools__buttons">
        <div className="tools__buttons-main">
          <button className="tools__buttons-main__like">
            <svg
              width="26"
              height="22"
              viewBox="0 0 26 22"
